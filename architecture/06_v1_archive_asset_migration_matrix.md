...
- `uHOME-empire` docs and course references for webhook/API automation teaching
...
- `uHOME-empire/src/webhooks/` for provider and webhook templates
- `uHOME-empire/docs/` for operator runbooks
- `uHOME-empire/scripts/` later, once real runtime contracts exist
